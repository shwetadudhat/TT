package com.technlogi.tt.user.ui.cancelledlist;
...
import com.technlogi.tt.user.adapters.CancelledListAdapter;
 ...
 * Use the {@link UserCancelledList#newInstance} factory method to
 * create an instance of this fragment.
 */
public class UserCancelledList extends Fragment {
     ...
     * @return A new instance of fragment UserCancelledList.
     */
    // TODO: Rename and change types and number of parameters
    public static UserCancelledList newInstance(String param1, String param2) {
        UserCancelledList fragment = new UserCancelledList();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rvCancelledList =  view.findViewById(R.id.user_rvCancelledList);
        ...
        CancelledListAdapter adapter = new CancelledListAdapter(history);
        rvCancelledList.setLayoutManager(new LinearLayoutManager(getContext()));
        rvCancelledList.setHasFixedSize(false);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_user_cancelled_list, container, false);
    }
}