 ...
 * Use the {@link UserBiddingList#newInstance} factory method to
 * create an instance of this fragment.
 */
public class UserBiddingList extends Fragment {
     ...
     * @return A new instance of fragment UserBiddingList.
     */
    // TODO: Rename and change types and number of parameters
    public static UserBiddingList newInstance(String param1, String param2) {
        UserBiddingList fragment = new UserBiddingList();
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rvBiddingList =  view.findViewById(R.id.user_rvBiddingList);
        ...
        BiddingListAdapter adapter = new BiddingListAdapter(getContext(),history);
        rvBiddingList.setLayoutManager(new LinearLayoutManager(getContext()));
        rvBiddingList.setHasFixedSize(false);
        rvBiddingList.setAdapter(adapter);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_user_bidding_list, container, false);
    }
}