package com.technlogi.tt.user.ui.booking;
...
import com.technlogi.tt.user.adapters.BookingFragmentAdapter;
...
public class Booking extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        backBtn = (ImageView) view.findViewById(R.id.user_bookingBackBtn);
        ...
        tabLayout = (TabLayout) view.findViewById(R.id.user_booking_TabLayout);
        viewPager2 = (ViewPager2) view.findViewById(R.id.user_booking_ViewPager);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_user_booking, container, false);
